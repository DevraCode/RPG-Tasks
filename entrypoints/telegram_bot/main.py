...
from .handlers_basicos import start, pide_nombre_usuario, nombre_usuario, contraseña, email, cancelar, vincular, obtener_username, obtener_password, handle_message
...
if __name__ == "__main__":
    ...
    app.add_handler(CommandHandler("user", handle_message))
